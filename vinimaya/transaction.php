...
<style>
 ...
 body
 {
     background-image:url(./images/pic65.jpg);
     background-size:100%;
     margin-top:3%;
     text-align:left;
...
echo "<table style='border: solid 2px black; left:20%;'>";
  echo "<tr><th>book</th><th>borrower</th><th>issue_date</th><th>due_date</th><th>return_date</th></tr><br/><br/>";
...
try {
     ...
     $stmt = $conn->prepare("SELECT i.book_name,i.borrower_name,i.issue_date,i.due_date,r.ret_date FROM issue_bk i,submit_bk r where i.book_name=r.book_name and i.borrower_name=r.borrower_name order by issue_date");

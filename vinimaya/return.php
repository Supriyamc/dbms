...
$book_name= $video_name = $borrower_name =$issue_date=$due_date=$sname="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($borrower_name_err) && empty($issue_date_err) && empty($due_date_err)&& empty($sname_err))
    {
        ...
        $sql = "INSERT INTO issue(book_name,video_name,borrower_name,issue_date,due_date,sname) VALUES (?, ?,?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_book_name, $param_video_name,$param_borrower_name,$param_issue_date,$param_due_date,$param_sname);
...
if (isset($_POST['book_name']) && isset($_POST['video_name'])&& isset($_POST['borrower_name'])&&isset($_POST['issue_date'])&&isset($_POST['due_date'])&&isset($_POST['sname']))
    {
        ...
        $sname=$_POST['sname'];
        $query = "INSERT INTO issue (book_name, video_name, borrower_name,issue_date,due_date,sname) VALUES ('$book_name','$video_name','$borrower_name','$issue_date','$due_date','$sname')";
        ...
        if($result){
          ...
          $sql= "UPDATE book SET available_copies=available_copies-1   WHERE title='$book_name'";
...
<body style="background-image:url(./images/bck.jpg); background-size: 100%;">
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div id="buttons">
            <a href="http://localhost/vinimaya/page2.php" target="_blank"><button type="button" style="left:50%; text-align:center; padding:10px; width:60px;"> Back </button></a>
            ...
            <input type="reset" value="Reset" style="left:50%; text-align:center; padding:10px; width:70px;">
              ...
              <a href="http://localhost/vinimaya/booksuccess.html" target="_blank" style="float:right"> finish</a>
        </form>
    </div>    
</body>
</html>

...
$book_name=$ret_date=$borrower_name="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 if(empty(trim($_POST["borrower_name"]))){
    ...
    if(empty($ret_date_err))
    {
        ...
        $sql = "INSERT INTO submit_bk(book_name,borrower_name,ret_date) VALUES (?,?, ?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_book_name,$param_borrower_name,$param_ret_date);
...
if (isset($_POST['book_name']) && isset($_POST['borrower_name'])&&isset($_POST['ret_date']))
    {
        ...
        $query = "INSERT INTO submit_bk (book_name, borrower_name,ret_date) VALUES ('$book_name','$borrower_name','$ret_date')";

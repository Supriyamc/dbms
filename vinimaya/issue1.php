...
$book_name = $borrower_name =$issue_date=$due_date=$sname="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($borrower_name_err) && empty($issue_date_err) && empty($due_date_err)&& empty($sname_err))
    {
        ...
        $sql = "INSERT INTO issue_bk(book_name,borrower_name,issue_date,due_date,sname) VALUES (?, ?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_book_name,$param_borrower_name,$param_issue_date,$param_due_date,$param_sname);
...
if (isset($_POST['book_name']) && isset($_POST['borrower_name'])&&isset($_POST['issue_date'])&&isset($_POST['due_date'])&&isset($_POST['sname']))
    {
        ...
        $sname=$_POST['sname'];
        $query = "INSERT INTO issue_bk (book_name,borrower_name,issue_date,due_date,sname) VALUES ('$book_name','$borrower_name','$issue_date','$due_date','$sname')";

...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO user (username,email_id,password) VALUES (?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_username, $param_email_id,$password);
...
<body style="background-image:url(./images/pic26.jpg); background-size: 100%;">
<header>
<h2 style="text-allign:center;color:purple; padding:20px; font-size:60px; font-style:bold;">Vinimaya</h2>
<div id="icon">
<a href="http://localhost/vinimaya/page1.php" target="_blank"><i class="fa fa-home"></i></a>
</div>
</header>
    <div id="page-wrap">
        <h2 style="font-size:35px;">Sign Up and Join</h2>
        <form  method="post">
            <p>
